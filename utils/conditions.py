...
def _choose_emoji(current_weather: dict) -> dict:
    keys = ['cloudCover', 'windSpeed', 'rainAccumulation', 'sleetAccumulation', 'snowAccumulation',
    ...
    weather_emojis = {
        ...
        'sleetAccumulation': ['\u2744\uFE0F', '\u2603\uFE0F', '\U0001f328\uFE0F'],
        'snowAccumulation': ['\u2744\uFE0F', '\u2603\uFE0F', '\U0001f328\uFE0F']
    }
    chosen_emojis = {}
    for key in keys:
    ...
    max_key, max_accumulation = 'rainAccumulation', current_weather['rainAccumulation']
