...
def _get_time_zone(user_id, latitude=None, longitude=None, city=None, country=None) -> dict:
    ...
    if response.status_code == 200:
        return response.json()['features'][0]['properties']['timezone']['offset_STD']
    else:
...
class GetTimeZoneInterface:
    @classmethod
    def get_time_zone(cls, user_id) -> None:
        try:
            RedisDatabaseInterface.set_redis(user_id, "timezone",
                                             _get_time_zone(user_id,
...
if __name__ == '__main__':
    ...
    RedisDatabaseInterface.set_redis(123, "location", {"country": "Russia", "city": "Saint Petersburg"})
    # GetLocationInterface.get_location(123)
    print(GetTimeZoneInterface.get_time_zone(123))